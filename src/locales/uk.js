...
module.exports = {
  ...
  'exclude.addForm': 'Додати «{value}» до списку ({noun})',
  'exclude.removeForm': 'Прибрати «{value}» зі списку ({noun})',
  'exclude.addStem': 'Додати всі форми «{value}» до списку ({noun})',
  'exclude.removeStem': 'Прибрати всі форми «{value}» зі списку ({noun})',
