...
module.exports = {
  ...
  'cmd.openWord': 'Öffnen, was das Wort unter dem Cursor benennt',
  ...
  'cmd.resumeSpelling': 'Diese Schreibweise nicht mehr ausschließen',
  'cmd.resumeForms': 'Formen dieses Wortes nicht mehr ausschließen',
  'cmd.includeTermAtCursor': 'Diesen Begriff nicht mehr ausschließen',
  'cmd.excludeNote': 'In dieser Notiz nie verlinken',
  'cmd.unexcludeNote': 'Diese Notiz nicht mehr immer ausschließen',
  ...
  'exclude.addForm': '„{value}“ zu {noun} hinzufügen',
  'exclude.removeForm': '„{value}“ aus {noun} entfernen',
  'exclude.addStem': 'Alle Formen von „{value}“ zu {noun} hinzufügen',
  ...
  'set.excludeWords.desc': 'Wörter im Text, eines pro Zeile, die nie einen Link auslösen, auch wenn sie zu einem Begriff passen. Eine Zeile stoppt nur diese Schreibweise; mit * am Ende alle Formen des Wortes.',
